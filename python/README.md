...
A Python CLI tool that parses Splunk raw log files, flags critical events, and detects anomalies using a sliding window algorithm.

Built as part of my SRE portfolio to demonstrate Python automation and observability skills.
...
Detects anomalies — alerts if 50+ errors occur within any 2-minute window
...
datetime / timedelta — for sliding window anomaly detection
